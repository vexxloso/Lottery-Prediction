                ...
                <div style={{ margin: '12px 0 4px', padding: '10px 12px', background: 'var(--color-surface-hover, #f5f5f5)', borderRadius: 8, fontSize: '0.78rem' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                    ...
                    {progress.reintegro_accuracy != null && (
                      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                        <span>GBM reintegro</span>
                        <span style={{ fontWeight: 700, color: progress.reintegro_accuracy > 0.8 ? '#16a34a' : '#f59e0b' }}>
                          {(progress.reintegro_accuracy * 100).toFixed(1)}%
                        </span>
                      </div>
                    )}
                  </div>
                  <Link to="/validation" style={{ display: 'block', marginTop: 8, fontSize: '0.75rem', color: '#00843d', textDecoration: 'none', fontWeight: 600 }}>
